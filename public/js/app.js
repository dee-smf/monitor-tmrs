...
const cumulativeOp = new CumulativeSumOperation();
const cumulative = cumulativeOp.execute(rolling);
console.log(cumulative);

const tableRenderer = new HtmlTableRenderer('#application');
tableRenderer.render(cumulative);

const chartRenderer = new JsDelivrChartRenderer('#application');
chartRenderer.render(cumulative);
